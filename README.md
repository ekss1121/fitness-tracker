...
- List foods: `GET /foods?user=alice`
- List all logs for a user: `GET /logs?user=alice`
- Log a food: `POST /foods` with JSON body `{ "user": "alice", "name": "Toast", "calories": 120, "date": "2024-06-01" }`
